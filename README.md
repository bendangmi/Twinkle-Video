<p align="center">
  <img src="web/public/logo.svg?v=0.0.7.custom.2" width="108" alt="VOZEB PRO logo">
</p>
...
<p align="center">
  ...
  <a href="VERSION"><img src="https://img.shields.io/badge/version-v0.0.7.custom.2-2563eb?style=flat-square" alt="Version"></a>
...
<p align="center">
  ...
  <a href="docs/content/docs/overview/configuration.mdx">0.0.7.custom.2 发布说明</a> ·
...
> 安装过 0.0.2 的用户必须先删除旧数据库或数据库卷，再重新安装 0.0.7.custom.2，并通过 `/install` 重新初始化数据库；不支持沿用旧数据库或原地升级。
